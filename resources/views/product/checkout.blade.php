    ...
    <div class="row">
            ...
            <div class="tp-checkout-verify-item">
                ...
                <div id="tpReturnCustomerLoginForm" class="tp-return-customer">
                    <form action="#">
                        ...
                        <button type="submit" class="tp-btn-square">Login</button>
                    </form>
                </div>
            </div>
            <div class="tp-checkout-verify-item">
                ...
                <div id="tpCheckoutCouponForm" class="tp-return-customer">
                    <form action="#">
                        ...
                        <button type="submit" class="tp-btn-square">Apply</button>
                    </form>
                </div>
            </div>
            </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="tp-checkout-btn-wrapper">
                <a href="cart.html" class="tp-btn-square text-center w-100">Place Order</a>
            </div>
            </div>
        </div>
    </div>
