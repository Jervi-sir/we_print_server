    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-8 col-xl-8 col-lg-8">
                ...
                <article class="postbox__item format-image mb-60 transition-3">
                    ...
                    <div class="postbox__content">
                        ...
                        <div class="postbox__read-more d-flex justify-content-between">
                            <a class="p-relative" href="blog-details.html">read more
                            ...
                            <svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.3994 19.5729C11.0801 19.5729 10.7722 19.4594 10.5322 19.2533C9.62606 18.4762 8.75239 17.7459 7.98158 17.1017L7.97764 17.0983C5.71774 15.2096 3.76623 13.5784 2.40841 11.9716C0.890572 10.1754 0.183594 8.47222 0.183594 6.61164C0.183594 4.80393 0.815613 3.13621 1.96311 1.91546C3.12429 0.680282 4.7176 0 6.45005 0C7.74489 0 8.93072 0.401489 9.9745 1.19322C10.5013 1.59286 10.9787 2.08197 11.3994 2.65248C11.8202 2.08197 12.2976 1.59286 12.8245 1.19322C13.8683 0.401489 15.0541 0 16.3489 0C18.0812 0 19.6747 0.680282 20.8359 1.91546C21.9834 3.13621 22.6152 4.80393 22.6152 6.61164C22.6152 8.47222 21.9084 10.1754 20.3906 11.9715C19.0328 13.5784 17.0814 15.2094 14.8219 17.098C14.0497 17.7432 13.1746 18.4747 12.2664 19.2537C12.0266 19.4594 11.7186 19.5729 11.3994 19.5729ZM6.45005 1.28872C5.08897 1.28872 3.83863 1.82147 2.92902 2.78894C2.00589 3.77101 1.49743 5.12855 1.49743 6.61164C1.49743 8.17647 2.09043 9.57597 3.42002 11.1494C4.70511 12.6702 6.61657 14.2678 8.82975 16.1176L8.83385 16.121C9.60758 16.7677 10.4847 17.5008 11.3975 18.2837C12.3159 17.4993 13.1943 16.765 13.9696 16.1173C16.1826 14.2675 18.0939 12.6702 19.379 11.1494C20.7084 9.57597 21.3014 8.17647 21.3014 6.61164C21.3014 5.12855 20.7929 3.77101 19.8698 2.78894C18.9604 1.82147 17.7098 1.28872 16.3489 1.28872C15.3519 1.28872 14.4365 1.59958 13.6282 2.21255C12.9078 2.75906 12.4061 3.44992 12.1119 3.93331C11.9606 4.18189 11.6943 4.33027 11.3994 4.33027C11.1045 4.33027 10.8382 4.18189 10.687 3.93331C10.3929 3.44992 9.89116 2.75906 9.17066 2.21255C8.36236 1.59958 7.44694 1.28872 6.45005 1.28872Z" fill="black"/>
                            </svg>
                            </span>
                        </div>
                    </div>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4">
                        ...
                        <div class="sidebar__post rc__post">
                            ...
                            <div class="rc__post-content">
                                ...
                                <h3 class="rc__post-title">
                                    <a href="blog-details.html">Budget Issues Force The Our To Become</a>
                                </h3>
                            </div>
                            </div>
                            <div class="rc__post mb-30 d-flex align-items-center">
                            ...
                            <div class="rc__post-content">
                                ...
                                <h3 class="rc__post-title">
                                    <a href="blog-details.html">The Best Products That Shape Fashion</a>
                                </h3>
                            </div>
                            </div>
                ...
                <div class="sidebar__widget mb-30">
                    <h3 class="sidebar__widget-title">Populer Tags</h3>
                    <div class="sidebar__widget-content">
                        <div class="tagcloud">
                            <a href="#">symphony</a>
                            <a href="#">nokia</a>
