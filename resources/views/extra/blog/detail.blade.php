...
<div class="tp-breadcrumb__area fix tp-breadcrumb-height" data-background="assets/img/breadcrumb/breadcrumb.png">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="col-xxl-8 col-xl-8 col-lg-8">
            <div class="postbox__wrapper">
                ...
                <div class="postbox__thumb m-img">
                    <img class="w-100" src="assets/img/blog/blog-details-4.jpg" alt="">
                </div>
                <div class="postbox__content">
                    ...
                    <div class="postbox__text">
                        <p>he whimsically named Egg Canvas is the brainchild of Erica Choi, a design director and photo
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vulputate vestibulum rhon
                            cus, dolor eget viverra pretium, dolor tellus aliquet nunc, vitae ultricies erat elit eu lacus. Vestibulum non justo fun consectetur, cursus ante, tincidunt sapien. Nulla quis diam sit amet turpis interd enim. Vivamus fauc ex sed nibh egestas elementum. Mauris et bibendum</p>
                        ...
                        <div class="postbox__list">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-5">
                                <div class="posbox__list-img">
                                    <img class="w-100" src="assets/img/blog/blog-details-5.jpg" alt="">
                                </div>
                            </div>
                            </div>
                        </div>
                        <div class="postbox__thumb m-img p-relative">
                            ...
                            <img class="w-100" src="assets/img/blog/blog-details-6.jpg" alt="">
                            <div class="postbox__play-btn">
                                <a class="popup-video" href="https://www.youtube.com/watch?v=hQIfjJbIy6o&amp;ab_channel=GaanBanglaTV"><i class="fa-sharp fa-solid fa-play"></i></a>
                            </div>
                            </div>
                            <span class="postbox-details-desc-thumb-caption"> “Amazing Beach Scenery & Relaxing Ocean  Sounds”</span>
                        </div>
                ...
                <ul>
                        ...
                        <div class="postbox__comment-box p-relative">
                            <div class="postbox__comment-info d-flex">
                                <div class="postbox__comment-avater mr-20">
                                    <img src="assets/img/blog/blog-details-sm-5.jpg" alt="">
                                </div>
                            ...
                            <p>There are many variations of passages of Lorem Ipsum available, but the leap into electronic
                    ...
                    <li class="children">
                        <div class="postbox__comment-box">
                            <div class="postbox__comment-info d-flex">
                                <div class="postbox__comment-avater mr-20">
                                    <img src="assets/img/blog/blog-details-sm-6.jpg" alt="">
                                </div>
                                <div class="postbox__comment-name">
                                    <h5>Johan Ritaxon</h5>
                ...
                <form id="contact-form" action="#">
                    <div class="row">
                        ...
                        <div class="col-xxl-12">
                            ...
                            <button type="submit" class="tp-btn-square">Send Message</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="sidebar__wrapper">
                ...
                <div class="sidebar__widget-content">
                    <div class="sidebar__post rc__post">
                        ...
                        <div class="rc__post mb-30 d-flex align-items-center">
                            <div class="rc__post-thumb mr-20">
                            <a href="blog-details.html"><img src="assets/img/blog/blog-details-sm-3.jpg" alt=""></a>
                            </div>
                            <div class="rc__post-content">
                            <div class="rc__meta">
                                <span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="rc__post mb-20 d-flex align-items-center">
                            <div class="rc__post-thumb mr-20">
                            <a href="blog-details.html"><img src="assets/img/blog/blog-details-sm-2.jpg" alt=""></a>
                            </div>
                            <div class="rc__post-content">
                            <div class="rc__meta">
                                <span><svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-cta-4__content text-center z-index">
                        ...
                        <a class="tp-btn-lg" href="#">Explore More
                            <i>
